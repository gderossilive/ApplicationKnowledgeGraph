...
resource sqlBootstrap 'Microsoft.Compute/virtualMachines/extensions@2024-07-01' = {
  ...
  properties: {
    ...
    protectedSettings: {
      ...
      commandToExecute: 'powershell.exe -ExecutionPolicy Bypass -File Bootstrap-SqlVm.ps1 -AdminUsername "${adminUsername}" -SqlAdminPasswordBase64 "${base64(sqlAdminPassword)}" -SqlAppPasswordBase64 "${base64(sqlAppPassword)}" -SchemaScriptSha256 "${sqlDatabaseSchemaScriptSha256}" -SeedScriptSha256 "${sqlDatabaseSeedScriptSha256}"'
    }
  }
}
